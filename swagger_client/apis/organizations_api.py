...
class OrganizationsApi(object):
    ...
    def get_all_organizations_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        response_type='list[Organizations]',
    ...
    def get_organization(self, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_organization(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_organization_with_http_info(id, **kwargs)
        else:
            (data) = self.get_organization_with_http_info(id, **kwargs)
            return data

    def get_organization_with_http_info(self, id, **kwargs):
        """
        getOrganization
        Get data of Organization by Organization's id
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_organization_with_http_info(id, callback=callback_function)
        ...
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_organization`")
